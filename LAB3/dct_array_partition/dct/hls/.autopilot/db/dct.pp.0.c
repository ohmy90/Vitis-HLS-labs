...
#pragma HLS array_partition variable=col_inbuf type=2 dim=2
...
#pragma HLS pipeline II=1
   ...
   VITIS_LOOP_100_1: for (r = 0; r < 8; r++) {
RD_Loop_Col:
...
#pragma HLS pipeline II=1
   ...
   VITIS_LOOP_115_1: for (r = 0; r < 8; r++) {
WR_Loop_Col:
...
#pragma HLS array_partition variable=buf_2d_in type=2

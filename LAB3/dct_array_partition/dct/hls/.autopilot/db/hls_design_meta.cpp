...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_r_address1", 6, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("input_r_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("input_r_q1", 16, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
	...
	Port_Property("output_r_address1", 6, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("output_r_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("output_r_we1", 1, hls_out, 1, "ap_memory", "MemPortWE2", 1),
	Port_Property("output_r_d1", 16, hls_out, 1, "ap_memory", "MemPortDIN2", 1),
};

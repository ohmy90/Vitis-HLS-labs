...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_outbuf \
    op interface \
    ports { row_outbuf_address0 { O 3 vector } row_outbuf_ce0 { O 1 bit } row_outbuf_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_1 \
    op interface \
    ports { row_outbuf_1_address0 { O 3 vector } row_outbuf_1_ce0 { O 1 bit } row_outbuf_1_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_2 \
    op interface \
    ports { row_outbuf_2_address0 { O 3 vector } row_outbuf_2_ce0 { O 1 bit } row_outbuf_2_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_3 \
    op interface \
    ports { row_outbuf_3_address0 { O 3 vector } row_outbuf_3_ce0 { O 1 bit } row_outbuf_3_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_3'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_4 \
    op interface \
    ports { row_outbuf_4_address0 { O 3 vector } row_outbuf_4_ce0 { O 1 bit } row_outbuf_4_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_4'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_5 \
    op interface \
    ports { row_outbuf_5_address0 { O 3 vector } row_outbuf_5_ce0 { O 1 bit } row_outbuf_5_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_5'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_6 \
    op interface \
    ports { row_outbuf_6_address0 { O 3 vector } row_outbuf_6_ce0 { O 1 bit } row_outbuf_6_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_6'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename row_outbuf_7 \
    op interface \
    ports { row_outbuf_7_address0 { O 3 vector } row_outbuf_7_ce0 { O 1 bit } row_outbuf_7_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_outbuf_7'"
}
}

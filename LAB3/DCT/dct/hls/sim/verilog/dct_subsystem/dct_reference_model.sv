...
`ifndef DCT_REFERENCE_MODEL_SV
`define DCT_REFERENCE_MODEL_SV

class dct_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(dct_reference_model)

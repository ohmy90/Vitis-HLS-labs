...
#pragma HLS pipeline II=1
      VITIS_LOOP_43_1: for(n = 0, tmp = 0; n < 8; n++) {
...
#pragma HLS pipeline II=1
      ...
      VITIS_LOOP_100_1: for (c = 0; c < 8; c++)
         buf[r][c] = input[r * 8 + c];
   }
}
...
#pragma HLS pipeline II=1
      ...
      VITIS_LOOP_115_1: for (c = 0; c < 8; c++)

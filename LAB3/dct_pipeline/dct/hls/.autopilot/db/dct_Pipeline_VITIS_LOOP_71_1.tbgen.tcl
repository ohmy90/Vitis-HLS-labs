set moduleName dct_Pipeline_VITIS_LOOP_71_1
set isTopModule 0
...
set cdfgNum 9
set C_modelName {dct_Pipeline_VITIS_LOOP_71_1}
...
dict set ap_memory_interface_dict col_inbuf { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {

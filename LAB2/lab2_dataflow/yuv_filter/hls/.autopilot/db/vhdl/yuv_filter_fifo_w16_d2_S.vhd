...
entity yuv_filter_fifo_w16_d2_S is 
    generic (
...
architecture rtl of yuv_filter_fifo_w16_d2_S is
...
------------------------Component----------------------
    component yuv_filter_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_yuv_filter_fifo_w16_d2_S_ShiftReg : yuv_filter_fifo_w16_d2_S_ShiftReg
    generic map (
...
entity yuv_filter_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yuv_filter_fifo_w16_d2_S_ShiftReg;

architecture rtl of yuv_filter_fifo_w16_d2_S_ShiftReg is

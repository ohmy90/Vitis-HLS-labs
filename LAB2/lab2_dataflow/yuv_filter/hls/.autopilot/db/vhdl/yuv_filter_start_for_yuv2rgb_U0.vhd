...
entity yuv_filter_start_for_yuv2rgb_U0 is 
    generic (
...
architecture rtl of yuv_filter_start_for_yuv2rgb_U0 is
...
------------------------Component----------------------
    component yuv_filter_start_for_yuv2rgb_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_yuv_filter_start_for_yuv2rgb_U0_ShiftReg : yuv_filter_start_for_yuv2rgb_U0_ShiftReg
    generic map (
...
entity yuv_filter_start_for_yuv2rgb_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yuv_filter_start_for_yuv2rgb_U0_ShiftReg;

architecture rtl of yuv_filter_start_for_yuv2rgb_U0_ShiftReg is

...
entity yuv_filter_fifo_w8_d3_S is 
    generic (
...
architecture rtl of yuv_filter_fifo_w8_d3_S is
...
------------------------Component----------------------
    component yuv_filter_fifo_w8_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_yuv_filter_fifo_w8_d3_S_ShiftReg : yuv_filter_fifo_w8_d3_S_ShiftReg
    generic map (
...
entity yuv_filter_fifo_w8_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yuv_filter_fifo_w8_d3_S_ShiftReg;

architecture rtl of yuv_filter_fifo_w8_d3_S_ShiftReg is

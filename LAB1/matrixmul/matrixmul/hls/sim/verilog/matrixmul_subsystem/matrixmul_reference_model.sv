...
`ifndef MATRIXMUL_REFERENCE_MODEL_SV
`define MATRIXMUL_REFERENCE_MODEL_SV

class matrixmul_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(matrixmul_reference_model)
